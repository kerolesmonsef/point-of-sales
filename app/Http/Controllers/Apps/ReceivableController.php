...
class ReceivableController extends Controller
{
    ...
    public function pay(Request $request, Receivable $receivable)
    {
        ...
        if ($validated['amount'] > $remaining) {
            return back()->with('error', __('Amount exceeds remaining receivable.'));
        }
        ...
        return redirect()
            ...
            ->with('success', __('Receivable payment recorded successfully.'));
    }
    ...
    public function updateCollectionNotes(Request $request, Receivable $receivable)
    {
        ...
        return back()->with('success', __('Collection notes saved successfully.'));
    }
}
