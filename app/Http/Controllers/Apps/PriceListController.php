...
class PriceListController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', __('Price list created.'));
    }
    ...
    {
        $priceList->delete();
        return back()->with('success', __('Price list deleted.'));
    }
