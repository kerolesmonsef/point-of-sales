        ...
        const fetchHistory = async () => {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    setError(result.message || __("Failed to load data"));
                }
            } catch (err) {
                console.error("Customer history error:", err);
                setError(__("Failed to load customer data"));
            } finally {
                setLoading(false);
            }
        };
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-px bg-slate-100 dark:bg-slate-800 sm:grid-cols-4">
                <div className="bg-white dark:bg-slate-900 p-3 text-center">
                    ...
                    <p className="text-xs text-slate-500">{__("Transactions")}</p>
                </div>
                <div className="bg-white dark:bg-slate-900 p-3 text-center">
                    <div className="flex items-center justify-center mb-1">
                ...
                <div className="bg-white dark:bg-slate-900 p-3 text-center">
                    ...
                    <p className="text-xs text-slate-500">{__("Last Visit")}</p>
                </div>
                <div className="bg-white dark:bg-slate-900 p-3 text-center">
                    <div className="flex items-center justify-center mb-1">
                    ...
                    <p className="text-sm font-medium uppercase text-slate-700 dark:text-slate-300">
                        {loyalty?.is_member ? loyalty.tier : __("Non-member")}
                    </p>
                    <p className="text-xs text-slate-500">{__("Tier")}</p>
                </div>
                <div className="bg-white dark:bg-slate-900 p-3 text-center">
                    <div className="flex items-center justify-center mb-1">
                    ...
                    <p className="text-xs text-slate-500">{__("Points")}</p>
                </div>
            </div>
