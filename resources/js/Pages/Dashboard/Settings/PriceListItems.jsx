            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500">{priceList.items.length} {__("products")}</p>
                    </div>
                </div>

                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5">
                    <h3 className="font-semibold mb-3">{__("Add Price")}</h3>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                    {priceList.items.length > 0 ? (
                        ...
                        <div className="p-8 text-center text-slate-400">{__("No items yet. Search products above to add.")}</div>
                    )}
                </div>
            </div>
        </>
