...
export default function Create({ warehouses = [] }) {
    ...
    const submit = (event) => {
        ...
        post(route("stock-opnames.store"), {
            onError: () => toast.error(__("Failed to create stock opname session")),
        });
    };

    return (
        <>
            <Head title={__("Create Stock Opname")} />
            ...
            <div className="mb-6">
                ...
                <h1 className="flex items-center gap-2 text-2xl font-bold text-slate-900 dark:text-white">
                    ...
                    {__("Create Stock Opname Session")}
                </h1>
            </div>
            ...
            <form onSubmit={submit} className="max-w-3xl">
                <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                    ...
                    <Textarea
                        ...
                        placeholder={__("e.g. monthly opname for front warehouse")}
                        value={data.notes}
                    ...
                    <div className="mt-5 flex justify-end">
                        <Button
                            ...
                            label={processing ? __("Saving...") : __("Create Session")}
                            disabled={processing}
                        />
                    </div>
                </div>
