            ...
            <form onSubmit={submit} className="max-w-5xl">
                <div className="space-y-6">
                    <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                        <h2 className="mb-4 text-lg font-semibold text-slate-900 dark:text-white">{__("PO Information")}</h2>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                        <h2 className="mb-4 text-lg font-semibold text-slate-900 dark:text-white">{__("Purchase Items")}</h2>
                        ...
                        {data.items.length > 0 ? (
                            ...
                            <div className="rounded-xl border border-dashed border-slate-200 p-8 text-center dark:border-slate-700">
                                ...
                                <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">{__("Search for products above to add to PO.")}</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <Button
                            ...
                            label={processing ? __("Saving...") : __("Save PO")}
                            disabled={processing}
                        />
                    </div>
                </div>
